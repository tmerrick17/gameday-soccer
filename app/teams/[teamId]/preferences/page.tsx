    ...
    return (
      <div className="flex items-center gap-3">
        <button
          ...
          disabled={value <= min}
          className="flex h-9 w-9 items-center justify-center rounded-xl border border-gray-300 text-lg font-medium disabled:opacity-30"
        >
          −
        </button>
    ...
    <main className="mx-auto flex min-h-dvh max-w-md flex-col gap-6 p-6 pb-16">
      ...
      <section className="flex flex-col gap-3">
        ...
        {FIELD_ROLES.map((role) => (
          <label key={role} className="flex items-center justify-between text-sm font-medium text-gray-700">
            {role}
            <input
              type="number"
              min={1}
              ...
              className="w-20 rounded-xl border border-gray-300 px-3 py-2 text-center text-sm outline-none focus:border-green-500 focus:ring-2 focus:ring-green-200"
            />
          </label>
        ))}
        <div className="flex items-center justify-between text-sm text-gray-400">
          <span>Keeper</span>
          <span className="w-20 rounded-xl border border-gray-200 bg-gray-50 px-3 py-2 text-center">
            Full half
          </span>
        </div>
      </section>
      ...
      <section className="flex items-center justify-between gap-4">
        <div>
          <h2 className="text-sm font-semibold text-gray-700">Max wave size</h2>
          <p className="text-xs text-gray-400">Players swapped at one stoppage</p>
        </div>
      ...
      <section className="flex items-center justify-between gap-4">
        <div>
          <h2 className="text-sm font-semibold text-gray-700">Segment length</h2>
          <p className="text-xs text-gray-400">Minutes per rotation window</p>
        </div>
        <div className="flex items-center gap-3">
          <button
            type="button"
      ...
      <section className="flex items-center justify-between gap-4">
        <div>
          <h2 className="text-sm font-semibold text-gray-700">Half length</h2>
          <p className="text-xs text-gray-400">Minutes per half</p>
        </div>
        <input
          type="number"
          min={15}
      ...
      <section className="flex items-center justify-between gap-4">
        <div>
          <h2 className="text-sm font-semibold text-gray-700">Min subs for full waves</h2>
          <p className="text-xs text-gray-400">Below this, use breather mode</p>
        </div>
