...
/**
 * How the field rotates when the Subs pool is too small for full Waves.
 * `wave` = normal substitution events; `breather` = rotate Players through a
 * rest Position so short-rostered kids are not stuck on flat-out.
 */
export type CollapseMode = "wave" | "breather";
